  ...
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center gap-8 overflow-hidden p-6 text-center">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Fuel</h1>
        <p className="max-w-md text-balance text-muted-foreground">
          Личный трекер питания и тренировок. Дневник еды, планы тренировок,
          библиотека упражнений и личные рекорды — под вашим контролем.
        </p>
      </div>
